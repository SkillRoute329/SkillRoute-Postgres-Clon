...
export const BPC_2026 = 6864; // Base de Prestaciones y Contribuciones
...
export const calculateIRPF = (nominal: number): number => {
    ...
    const bracket1 = 7 * BPC_2026;
    const bracket2 = 10 * BPC_2026;
    const bracket3 = 15 * BPC_2026;
...
export const calculateLiquidation = (role: string, shifts: number, extras: number, metadata: any = {}): LiquidationResult => {
    const scale = (SALARY_SCALES as any)[role.toUpperCase()] || { base: 0, extra: 0 };
