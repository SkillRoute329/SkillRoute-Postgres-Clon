...
- generic [ref=e4]:
  ...
  - main [ref=e185]:
    ...
    - generic [ref=e205]:
      ...
      - generic [ref=e219]:
        - generic [ref=e220]:
          - heading "Captura Inspector" [level=1] [ref=e221]:
            - img [ref=e222]
            - text: Captura Inspector
          - paragraph [ref=e225]: Seleccione línea, servicio y punto de control. Luego Marcar Pasada.
        - main [ref=e226]:
          - generic [ref=e227]:
            - generic [ref=e228]: Línea
            - combobox [ref=e229]:
              - option "Seleccionar línea" [selected]
              - option "1041"
              - option "300"
              - option "306"
              - option "6011"
          - generic [ref=e230]:
            - generic [ref=e231]: Servicio / Cartón
            - combobox [disabled] [ref=e232]:
              - option "Seleccionar servicio" [selected]
          - generic [ref=e233]:
            - generic [ref=e234]: Punto de control
            - combobox "Seleccionar punto de control" [disabled] [ref=e235]:
              - option "Seleccionar servicio primero" [selected]
```