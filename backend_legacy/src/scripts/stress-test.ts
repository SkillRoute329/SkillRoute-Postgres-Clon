 ...
 *    (Powershell)
 *    $env:API_URL="https://ucot-gestor-cloud.web.app/api"; $env:TEST_USER="[USER_INTERNAL_ID]"; $env:TEST_PASS="[PASSWORD]"; npx tsx src/scripts/stress-test.ts
 * 
 *    (Bash)
 *    API_URL="https://ucot-gestor-cloud.web.app/api" TEST_USER="[USER]" TEST_PASS="[PASS]" npx tsx src/scripts/stress-test.ts
 */
