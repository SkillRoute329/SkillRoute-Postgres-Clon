/** Copyright 1997-1998 by Charles L. Taylor */
    ...
    var zone = 21; //Zona geográfica de Uruguay.
    ...
    * retorna un array xy que tiene en xy[0] la x y en xy[1] la y
    */
    function btnToUTM_OnClick (x,y)
    {
        var xy = new Array(2);
        /*
        ...
        //var lon = parseFloat (document.frmConverter.txtLongitude.value);
        ...
        //var lat = parseFloat (document.frmConverter.txtLatitude.value);
        ...
        var calculoZona = Math.floor ((lon + 180.0) / 6) + 1;

        zone = LatLonToUTMXY (DegToRad (lat), DegToRad (lon), zone, xy);
        //console.log('La zona UTM según la longitud es ' + calculoZona + ' y el valor zone es ' +zone);
