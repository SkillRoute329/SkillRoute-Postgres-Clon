...
exports.snapshotHistorial = snapshotHistorial;
/**
...
async function snapshotHistorial(agencyId = '70') {
    ...
    const r = await database_1.default.raw(`INSERT INTO cartones_historial
     ...
     ON CONFLICT (fecha, agency_id, vehiculo_id, service_number) DO NOTHING`, [hoy, tipoDia, agencyId, hoy]);
    const n = r.rowCount ?? 0;
    logger_1.default.info(`[cartonesHistorial] snapshot ${hoy} (${tipoDia}): +${n} filas`);
    return n;
}
