...
router.get('/alerts/history', (req, res) => {
  const filters = {};
  if (req.query.lineId) filters.lineId = parseInt(req.query.lineId);
...
router.get('/line/:lineId/orchestrator', (req, res) => {
  ...
  res.json({
    ...
    linkedAgents: ecosystem.ownAgents.length + ecosystem.competitorAgents.length
  });
});
...
router.get('/line/:lineId/analyzers', (req, res) => {
  ...
  res.json({
    lineId: lineId,
    totalAnalyzers: ecosystem.ownAgents.length,
...
router.get('/line/:lineId/competitors', (req, res) => {
  ...
  res.json({
    lineId: lineId,
    totalMonitors: ecosystem.competitorAgents.length,
