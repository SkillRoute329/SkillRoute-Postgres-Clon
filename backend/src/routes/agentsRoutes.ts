...
/**
 * Extender Request para incluir orchestrator
 */
 ...
 */
const getMasterOrchestrator = (req: OrchestratorRequest, res: Response, next: () => void) => {
  req.orchestrator = (req.app as any).locals?.masterOrchestrator;
  if (!req.orchestrator) {
 ...
 */
router.get('/status', (req: OrchestratorRequest, res: Response) => {
 ...
 */
router.get('/line/:lineId/status', (req: OrchestratorRequest, res: Response) => {
  ...
  res.json({
    ...
    agents: {
      ...
      ownAnalyzers: ecosystem.ownAgents.map((a: any) => ({
        id: a.id,
        destination: a.destinationNombre,
        sentido: a.sentido
      })),
      competitorMonitors: ecosystem.competitorAgents.map((a: any) => ({
        id: a.id,
 ...
 */
router.post('/line/:lineId/alert', async (req: OrchestratorRequest, res: Response) => {
  try {
    const lineId = parseInt(req.params.lineId);
 ...
 */
router.post('/line/:lineId/alert/analysis', async (req: OrchestratorRequest, res: Response) => {
  try {
    const lineId = parseInt(req.params.lineId);
 ...
 */
router.post('/line/:lineId/alert/competitor', async (req: OrchestratorRequest, res: Response) => {
  try {
    const lineId = parseInt(req.params.lineId);
 ...
 */
router.get('/alerts/history', (req: OrchestratorRequest, res: Response) => {
  const filters: any = {};
  if (req.query.lineId) filters.lineId = parseInt(req.query.lineId as string);
  if (req.query.tipo) filters.tipo = req.query.tipo;
  if (req.query.sentido) filters.sentido = req.query.sentido;
  if (req.query.horaInicio) filters.horaInicio = req.query.horaInicio;
 ...
 */
router.get('/alerts/statistics', (req: OrchestratorRequest, res: Response) => {
 ...
 */
router.delete('/alerts/history', (req: OrchestratorRequest, res: Response) => {
 ...
 */
router.get('/line/:lineId/orchestrator', (req: OrchestratorRequest, res: Response) => {
  const lineId = parseInt(req.params.lineId);
  const ecosystem = req.orchestrator?.getLineEcosystem(lineId);
 ...
 */
router.get('/line/:lineId/analyzers', (req: OrchestratorRequest, res: Response) => {
  const lineId = parseInt(req.params.lineId);
  const ecosystem = req.orchestrator?.getLineEcosystem(lineId);
 ...
 */
router.get('/line/:lineId/competitors', (req: OrchestratorRequest, res: Response) => {
  const lineId = parseInt(req.params.lineId);
  const ecosystem = req.orchestrator?.getLineEcosystem(lineId);
