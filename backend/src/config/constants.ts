...
if (process.env.JWT_SECRET && process.env.JWT_SECRET.length >= 32) {
  ...
  console.error(
    '[CRITICAL] JWT_SECRET no definido o demasiado corto en NODE_ENV=production.\n' +
  ...
  // eslint-disable-next-line no-console
  console.warn(
    '[SECURITY WARN] JWT_SECRET no definido en development; usando secret de desarrollo.\n' +
