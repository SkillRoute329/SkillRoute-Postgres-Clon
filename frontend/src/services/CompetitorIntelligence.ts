...
export interface CorridorDefinition {
  ...
  /** Bounding box geografico del corredor [latMin, lngMin, latMax, lngMax] */
...
export const CORRIDOR_MAP: CorridorDefinition[] = [
  ...
  // ❌ Eliminados 103/110: no comparten Av. Italia con la 300
  {
    ...
    variantCode: '300a',
    headingRange: [20, 110] as [number, number],
    rivals: ['161', '162', '163'],
    label: '300 → Instrucciones (IDA)',
    terminalOrigen: 'Cementerio Central',
    terminalDestino: 'Instrucciones y Belloni',
    corridorBbox: [-34.92, -56.2, -34.83, -56.05] as [number, number, number, number],
  },
  {
    lineId: '300',
    destino: 'CRIO_CENTRAL',
    variantCode: '300b',
    headingRange: [200, 290] as [number, number],
    rivals: ['161', '162', '163'],
  ...
  // ❌ Eliminado 76: no comparte el corredor Ruta 1/Casabó
  {
    ...
    destino: 'GÉANT',
    variantCode: '306a',
    headingRange: [50, 160] as [number, number],
    rivals: ['185', 'G'],
    label: '306 → Géant (IDA)',
    terminalOrigen: 'Casabó',
    terminalDestino: 'Géant',
    corridorBbox: [-34.95, -56.3, -34.75, -56.1] as [number, number, number, number],
  },
  {
    lineId: '306',
    destino: 'CASABÓ',
    variantCode: '306b',
    headingRange: [230, 340] as [number, number],
    rivals: ['185', 'G'],
  ...
  // ❌ Eliminados 100/103: son corredores Ciudad Vieja/Centro
  {
    ...
    destino: 'POCITOS',
    variantCode: '316a',
    headingRange: [160, 260] as [number, number],
    rivals: ['186', '187', '188'],
    label: '316 → Pocitos (IDA)',
    terminalOrigen: 'Cno. Maldonado',
    terminalDestino: 'Pocitos',
    corridorBbox: [-34.91, -56.18, -34.86, -56.1] as [number, number, number, number],
  },
  {
    lineId: '316',
    destino: 'CNO_MALDONADO',
    variantCode: '316b',
    headingRange: [340, 80] as [number, number],
    rivals: ['186', '187', '188'],
  ...
  // ❌ Eliminados 102/106: son corredores distintos (Cerrito/Larrañaga)
  {
    ...
    corridorBbox: [-34.92, -56.2, -34.88, -56.13] as [number, number, number, number],
  },
  {
    lineId: '328',
  ...
  // ❌ Eliminados 103/109: son corredores Goes/Larrañaga
  {
    ...
    variantCode: '330a',
    headingRange: [20, 160] as [number, number],
    rivals: ['147', '148', '185'],
    label: '330 → Ciudad Vieja (IDA)',
    terminalOrigen: 'Cerro (Villa del Cerro)',
    terminalDestino: 'Ciudad Vieja',
    corridorBbox: [-34.93, -56.3, -34.88, -56.2] as [number, number, number, number],
  },
  {
    lineId: '330',
    destino: 'CERRO',
    variantCode: '330b',
    headingRange: [200, 340] as [number, number],
    rivals: ['147', '148', '185'],
    label: '330 → Cerro (VTA)',
  ...
  // LÍNEA 370 IDA — Rivales: Cutcsa 110/103/112 (Rambla/Italia/Carrasco CONFIRMADO)
  {
    ...
    destino: 'PORTONES',
    variantCode: '370a',
    headingRange: [30, 150] as [number, number],
    rivals: ['110', '103', '112'],
    label: '370 → Portones (IDA)',
    terminalOrigen: 'Playa del Cerro',
    terminalDestino: 'Portones',
    corridorBbox: [-34.95, -56.3, -34.87, -56.0] as [number, number, number, number],
  },
  // LÍNEA 370 VTA — Rivales distintos en vuelta (128/137 Rambla vuelta)
  {
    ...
    destino: 'CERRO',
    variantCode: '370b',
    headingRange: [210, 330] as [number, number],
    rivals: ['128', '137', '185'],
  ...
  // ❌ Eliminado 103 puro (va por Goes, no Ramírez)
  {
    ...
    terminalDestino: 'Punta Carretas',
    corridorBbox: [-34.93, -56.3, -34.9, -56.14] as [number, number, number, number],
  },
  {
    lineId: '17',
    destino: 'CASABÓ',
  ...
  // LÍNEA 71 — Rivales: Cutcsa 121/122/124 (Bvar. Artigas/Av. Rivera VERIFICADO)
  {
    ...
    corridorBbox: [-34.92, -56.17, -34.87, -56.1] as [number, number, number, number],
  },
  {
    lineId: '71',
    destino: 'POCITOS',
  ...
  // ❌ Eliminado 110: es corredor Rambla, no 18 de Julio
  {
    ...
    corridorBbox: [-34.92, -56.2, -34.87, -56.09] as [number, number, number, number],
  },
  {
    lineId: '79',
    destino: 'CIUDAD_VIEJA',
  ...
  // ❌ ELIMINADOS 102/106: son líneas urbanas Montevideo, NO van a Sauce/San Ramón
  {
    ...
    destino: 'SAUCE',
    variantCode: '11Aa',
    headingRange: [0, 180] as [number, number],
    rivals: ['C1', 'Rubricay'],
    label: '11A → Sauce / San Ramón (IDA)',
    terminalOrigen: 'Terminal Baltasar Brum',
    terminalDestino: 'Sauce / San Ramón',
    corridorBbox: [-34.7, -56.1, -34.4, -55.9] as [number, number, number, number],
  },
  {
    lineId: '11A',
    destino: 'BALTASAR_BRUM',
    variantCode: '11Ab',
    headingRange: [180, 360] as [number, number],
    rivals: ['C1', 'Rubricay'],
  ...
  // ❌ ELIMINADOS 110/103: son líneas urbanas Rambla/18 de Jul, NO van a El Pinar
  {
    ...
    corridorBbox: [-34.9, -56.1, -34.75, -55.8] as [number, number, number, number],
  },
  {
    lineId: '221',
    destino: 'BALTASAR_BRUM',
  ...
  // ❌ ELIMINADO 103: línea urbana Montevideo, NO va a San Ramón
  {
    ...
    corridorBbox: [-34.7, -56.1, -34.35, -55.85] as [number, number, number, number],
  },
  {
    lineId: '8SR',
    destino: 'BALTASAR_BRUM',
