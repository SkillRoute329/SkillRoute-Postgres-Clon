...
const ResetApp = () => {
  ...
  const handleReset = async () => {
    if (
      !confirm(
        '¿Estás seguro? Esto borrará tus credenciales guardadas y reiniciará la aplicación. Usa esto si la aplicación no carga o se queda en blanco.',
      )
    )
      return;
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900 text-white p-4">
      <div className="max-w-md w-full bg-slate-800 rounded-2xl p-8 border border-slate-700 shadow-2xl text-center">
        ...
        <p className="text-slate-400 mb-8">
          Si estás viendo esta pantalla o la aplicación no responde, es probable que tu navegador
          tenga archivos antiguos o corruptos.
        </p>
