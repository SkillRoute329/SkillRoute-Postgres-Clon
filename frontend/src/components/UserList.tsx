...
import { Users, DollarSign, UserCheck, UserX, Search, Filter } from 'lucide-react';
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 gap-3">
                {loading ? <p className="text-center text-slate-500 py-8">Cargando personal...</p> : filteredUsers.map(user => (
                    <div key={user.internalNumber} className="bg-slate-900/50 border border-slate-800/50 hover:bg-slate-800/50 transition-colors p-4 rounded-xl flex flex-col md:flex-row gap-4 items-center group">
                        ...
                        <div className="flex items-center gap-4 w-full md:w-1/4">
                            ...
                            <div>
                                ...
                                <span className={`text-[10px] font-bold px-1.5 rounded ${user.roleName === 'Micrero' ? 'bg-amber-500/10 text-amber-500' : 'text-slate-500'}`}>
                        ...
                        <div className="w-full md:w-1/4 flex flex-col items-end md:items-start border-l border-slate-800 pl-0 md:pl-4">
                            <span className="text-[10px] text-slate-500 uppercase tracking-widest font-bold">Salario (Devengado)</span>
                        ...
                        <div className="w-full md:w-1/4 flex justify-end">
                            <button className="text-xs bg-slate-800 hover:bg-slate-700 text-white px-3 py-2 rounded-lg transition-colors border border-slate-700">
                                Ver Ficha
                            </button>
                        </div>
                    </div>
