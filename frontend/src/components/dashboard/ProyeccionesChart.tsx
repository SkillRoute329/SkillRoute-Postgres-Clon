...
import { ProyeccionIngresos } from '../../types/dashboard';
...
export function ProyeccionesChart({ proyecciones }: ProyeccionesChartProps) {
  ...
  const maxIngreso = Math.max(...datosGrafico.map(d => Math.max(d.actual, d.proyectado)));
            ...
            >
              ...
              <div className="mb-4">
                ...
                <p className="text-2xl font-bold text-gray-900">
                  ${(proy.ingresosActuales / 1000000).toFixed(1)}M
                </p>
              </div>
              ...
              <div className={`rounded-lg p-3 mb-4 flex items-center gap-2 ${
                ...
                <div>
                  ...
                  <p className={`text-lg font-bold ${
                    ...
                    {cambioPositivo ? '+' : ''}{proy.cambioEsperado}%
                  </p>
                </div>
              </div>
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          <div>
            ...
            <p className={`text-3xl font-bold ${
              ...
              {(proyecciones.reduce((sum, p) => sum + p.cambioEsperado, 0) / proyecciones.length).toFixed(1)}%
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-3xl font-bold text-blue-600">
              {Math.round(proyecciones.reduce((sum, p) => sum + p.confianza, 0) / proyecciones.length)}%
            </p>
          </div>
        </div>
