...
const VehicleCheckModal: React.FC<VehicleCheckModalProps> = ({ isOpen, onClose, onComplete, vehicleId }) => {
    const { token } = useAuth();
            ...
            <div className="bg-slate-900 border border-slate-700 rounded-3xl w-full max-w-xl shadow-2xl overflow-hidden animate-scale-in">
                ...
                {step === 'ask' && (
                    <div className="p-8 text-center">
                        ...
                        <p className="text-slate-400 mb-8">¿Desea realizar la inspección visual del coche #{vehicleId} antes de comenzar?</p>
                                ...
                                >
                                    {p ? (
                                        ...
                                        <>
                                            ...
                                            <span className="text-[10px] uppercase font-bold text-slate-500">{labels[i]}</span>
                                        </>
                                    )}
                                </button>
                            ))}
                    ...
                    <div className="p-8">
                        <div className="bg-red-500/10 border border-red-500/30 p-6 rounded-2xl mb-8">
                            ...
                            <p className="text-red-200 leading-relaxed font-medium">
                                Al omitir la inspección, usted asume la <strong>responsabilidad total</strong> por cualquier daño preexistente no reportado en el coche #{vehicleId}.
                            </p>
                        </div>
