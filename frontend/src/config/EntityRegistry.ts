...
export const ENTITY_REGISTRY: Record<string, EntityConfig> = {
  USERS: {
    ...
    columns: [
      ...
      { key: 'fullName', label: 'Nombre Completo', type: 'text', required: true, editable: true },
      {
        ...
        type: 'enum',
        options: ['User', 'Admin', 'SuperAdmin', 'Inspector'],
        required: true,
        editable: true,
      },
  ...
  STOCK: {
    // Mapped to Vehicles internally for now as Fleet Inventory
    labels: {
    ...
    columns: [
      ...
      { key: 'model', label: 'Modelo', type: 'text', editable: true },
      {
        ...
        label: 'Estado',
        type: 'enum',
        options: ['OPERATIONAL', 'MAINTENANCE', 'STOPPED'],
        editable: true,
      },
    ...
    columns: [
      {
        ...
        label: 'Tipo',
        type: 'enum',
        options: ['ACCIDENTE', 'FERIA', 'DESVIO', 'MANIFESTACION', 'OBRAS'],
        required: true,
        editable: true,
      },
  ...
  PARTS: {
    ...
    columns: [
      ...
      { key: 'description', label: 'Descripción', type: 'text', required: true, editable: true },
      {
        ...
        label: 'Categoría',
        type: 'enum',
        options: ['CONSUMIBLES', 'MOTORES', 'FRENOS', 'CARROCERIA', 'ELECTRICIDAD'],
        editable: true,
      },
      {
        key: 'currentStock',
  ...
  ROUTES: {
    ...
    columns: [
      { key: 'name', label: 'Línea', type: 'text', required: true, editable: true },
      {
        ...
        label: 'Tipo',
        type: 'enum',
        options: ['URBANA', 'SUBURBANA', 'LOCAL'],
        required: true,
        editable: true,
      },
      { key: 'description', label: 'Descripción', type: 'text', editable: true },
  ...
  RADAR: {
    ...
    columns: [
      ...
      { key: 'speedLimit', label: 'Límite (km/h)', type: 'number', required: true, editable: true },
      {
        ...
        label: 'Tipo',
        type: 'enum',
        options: ['CAMERA', 'RADAR', 'DANGEROUS_CURVE'],
        required: true,
        editable: true,
      },
    ],
  ...
  PENALTY_RULES: {
    ...
    columns: [
      { key: 'name', label: 'Falta / Motivo', type: 'text', required: true, editable: true },
      {
        ...
        label: 'Tipo',
        type: 'enum',
        options: ['EarlyArrival', 'LateArrival', 'LowLoad', 'Behavior'],
        required: true,
        editable: true,
      },
      {
        ...
        label: 'Sanción',
        type: 'enum',
        options: ['Suspension', 'Warning', 'Fine'],
        required: true,
        editable: true,
      },
