...
export const generateShiftTicket = (shift: any, user: any) => {
    const doc = new jsPDF({
    ...
    doc.text('Transforma Fáicl', centerX, y, { align: 'center' });
    y += 5;
    ...
    // Footer
    doc.setFontSize(7);
    doc.text(`Generado: ${format(new Date(), 'dd/MM/yyyy HH:mm:ss')}`, centerX, y, { align: 'center' });
